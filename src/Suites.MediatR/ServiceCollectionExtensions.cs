...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    /// After calling AddHostedMediatR you can use the container to resolve an <see cref="IMediator"/> instance.
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddHostedMediatR(this IServiceCollection services)
            => services.AddHostedMediatR(AppDomain.CurrentDomain.GetAssemblies().Where(a => !a.IsDynamic));
        ...
        /// <returns>Service collection</returns>
        public static IServiceCollection AddHostedMediatR(this IServiceCollection services, params Assembly[] assemblies)
            => services.AddHostedMediatR(assemblies.AsEnumerable());
        ...
        /// <param name="assemblies">Assemblies to scan</param>
        /// <returns>Service collection</returns>
        public static IServiceCollection AddHostedMediatR(this IServiceCollection services, IEnumerable<Assembly> assemblies)
        {
            AddRequiredServices(services);

            AddHostedMediatRClasses(services, assemblies);
        ...
        /// <returns>Service collection</returns>
        public static IServiceCollection AddHostedMediatR(this IServiceCollection services, params Type[] handlerAssemblyMarkerTypes)
            => services.AddHostedMediatR(handlerAssemblyMarkerTypes.AsEnumerable());
        ...
        /// <param name="handlerAssemblyMarkerTypes"></param>
        /// <returns>Service collection</returns>
        public static IServiceCollection AddHostedMediatR(this IServiceCollection services, IEnumerable<Type> handlerAssemblyMarkerTypes)
        {
            AddRequiredServices(services);
            AddHostedMediatRClasses(services, handlerAssemblyMarkerTypes.Select(t => t.GetTypeInfo().Assembly));
            return services;
        }

        private static void AddHostedMediatRClasses(IServiceCollection services, IEnumerable<Assembly> assembliesToScan)
        {
        ...
        {
            services.AddSingleton<ServiceFactory>(p => (type =>
            {
                try
                {
